...
from handin.strategy.extreme import ExtremeAggressiveBackUpS
...
class ExtremeBackUp(base_agent.BaseAgent):
    """
    ...
    SELECTED_STRATEGY = ExtremeAggressiveBackUpS
...
class ExtremeBackUpV2(ExtremeBackUp):
    pass
